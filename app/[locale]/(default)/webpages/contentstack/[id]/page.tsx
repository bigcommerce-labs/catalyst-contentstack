...
import { contentstackClient, contentstackGraphQL } from '~/contentstack/client';
import { LocaleType } from '~/i18n';

import RenderComponents from '../_components/render-components';
...
const WEBPAGES_QUERY = contentstackGraphQL(
  `
...
const getWebpageData = cache(async (variables: { id: string; locale: string }) => {
